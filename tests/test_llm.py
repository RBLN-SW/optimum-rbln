...
class TestLlavaNextForConditionalGeneration(LLMTest.TestLLM):
    ...
    def test_propagate_config(self):
        ...
        model = from_pretrained_cache_first(
            self.RBLN_CLASS, self.HF_MODEL_ID, **self.HF_CONFIG_KWARGS, **rbln_class_kwargs
        )
...
class TestQwen2VLForConditionalGeneration(LLMTest.TestLLM):
    ...
    def test_propagate_config(self):
        ...
        model = from_pretrained_cache_first(
            self.RBLN_CLASS, self.HF_MODEL_ID, **self.HF_CONFIG_KWARGS, rbln_config=rbln_config
        )
