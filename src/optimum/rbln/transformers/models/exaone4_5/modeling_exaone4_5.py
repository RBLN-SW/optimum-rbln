...
from .configuration_exaone4_5 import (
    ...
    RBLNExaone4_5_VisionPreTrainedModelConfig,
)
...
class RBLNExaone4_5_VisionPreTrainedModel(RBLNModel):
    ...
    def save_torch_artifacts(
        cls,
        model: "Exaone4_5_VisionPreTrainedModel",
        save_dir_path: Path,
        subfolder: str,
    ...
    @classmethod
    def _wrap_model_if_needed(cls, model: "PreTrainedModel", rbln_config: RBLNExaone4_5_VisionPreTrainedModelConfig):
    ...
    def __getattr__(self, __name: str) -> Any:
        ...
        val = getattr(Exaone4_5_VisionPreTrainedModel, __name)
    ...
    def _update_rbln_config(
        ...
        rbln_config: Optional[RBLNExaone4_5_VisionPreTrainedModelConfig] = None,
    ) -> RBLNExaone4_5_VisionPreTrainedModelConfig:
